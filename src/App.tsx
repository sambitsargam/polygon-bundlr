...
import { Input, HStack, Text, VStack, useToast, Menu, MenuButton, MenuList, MenuItem, Tooltip, Textarea, Divider, } from "@chakra-ui/react";
    ...
    <VStack mt={10}>
      ...
      {bundler && (
        <>
          ...
          <Divider w={1000} />
          <Text fontSize="xl">Write text here</Text>
